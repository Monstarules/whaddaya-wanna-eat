    ...
    try {
        const confirmationEmail = await transport.sendMail({
            ...
            html: `<h1>Email Confirmation</h1>
                ...
                <a href=https://waddaya-wanna-eat.herokuapp.com/confirm?acc={confirmationCode}> Click here</a>
                </div>`,
        })
    } catch (error) {
        console.log(error)
    ...
    try {
        const resetPassword = await transport.sendMail({
            ...
            html: `<h1>Reset Password</h1>
                ...
                <a href=https://waddaya-wanna-eat.herokuapp.com/resetPassword?acc=${userId}> Click here</a>
                </div>`,
        })
    } catch (error) {
        console.log(error)
